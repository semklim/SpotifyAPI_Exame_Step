...
async function funcUIList():Promise<any> {
  ...
  try {
    return `<div class="tracksBoxMain">
      <div class="tracksGrid">
        ...
        <div class="trackPreview">
          <img aria-hidden="false" draggable="false" loading="eager" src="${userTracks[1].track.album.images[2].url}" alt="img" class="trackPreview__img" width="40" height="40">
        ...
        <div class="trackLikeAndDuration">
          ...
          <div class="trackDurationTxt" data-encore-id="type">
            ${ msToTime(userTracks[1].track.duration_ms) }
          </div>
        </div>
      </div>
    </div>`
