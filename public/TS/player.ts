...
volumeSlider.addEventListener("input", () => {
  ...
  if (
    (volumeSlider.value as unknown as number) > 30 &&
    (volumeSlider.value as unknown as number) < 80
  ) {
    muteBtn.innerHTML =
    ...
    (volumeSlider.value as unknown as number) > 0 &&
    (volumeSlider.value as unknown as number) <= 30
  ) {
    muteBtn.innerHTML =
...
//PLAY/PAUSE
let playBtn = document.getElementsByClassName(
  "play-pauseBtn"
)[0] as HTMLButtonElement;
export let playBtnSVG = document.getElementsByClassName(
  "play-pauseSVG"
)[0] as SVGElement;
...
let audioCurrTime = document.getElementsByClassName(
  "songOnPlayCurrTime"
)[0] as HTMLSpanElement;
let audioFullDuration = document.getElementsByClassName(
  "songOnEndCurrTime"
)[0] as HTMLSpanElement;
let albumCover = document.getElementsByClassName(
  "albumCover"
)[0] as HTMLDivElement;
...
let repeatBtn = document.getElementsByClassName(
  "repeatTrackSvg"
)[0] as SVGElement;
...
let randomBtn = document.getElementsByClassName(
  "randTrackBtnSvg"
)[0] as SVGElement;
...
let trackTimeSlider = document.getElementById(
  "trackTimeSlider"
) as HTMLInputElement;
