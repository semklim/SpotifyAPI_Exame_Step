...
class Assets {
	...
	private static getTracksForAlbum(list: object[]){
		let html = '';
	...
	static tracksByPlaylist(obj: any){
		...
		<div class="play-favorite-track-box"  style="background-color: ${color};">
		  <div class="play-favorite-track">
			<button class="play-favorite-track__button" data-playlist-id="${id}">
		  ...
		  <div class="favorite-tracks-contents">
			...
			<!-- start -->
			${type !== 'album' ? Assets.getTracks(tracks) : Assets.getTracksForAlbum(tracks)}
			<!-- end -->
		  </div>
		</div>
	  </div>
