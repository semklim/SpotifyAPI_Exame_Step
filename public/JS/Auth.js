...
class SpotifyAuth {
			...
			return new Promise((resolve, reject) => {
				window.addEventListener('message', (event) => __awaiter(this, void 0, void 0, function* () {
					...
					if (access.type === 'code') {
						...
						const { access_token, refresh_token, expires_in } = yield this.exchangeAuthorizationCode(access.code);
	...
	exchangeAuthorizationCode(code) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (!response.ok) {
				const { error, error_description } = yield response.json();
...
const Auth = new SpotifyAuth(CLIENT_ID, REDIRECT_URI, CLIENT_SECRET, SCOPES);
export default Auth;
